...
# root@srv-homologacao:~# ls C:/Video/ 50102/2020-11-10/recorder/3/0000000000000000-201118-000000-003000-01p402000000.mp4/


class GerenciamentoDiretorio():
    def __init__(self, diretorio_origem, destino, nome_arquivo):
        self.diretorio_origem = diretorio_origem
        self.destino = destino
        self.nome_arquivo = nome_arquivo
        self.diretorio_origem_info = self.diretorio_origem.split("\\")

    def get_infos(self):
        
        antigo_nome_arquivo = self.nome_arquivo
        nome_arquivo_split = self.nome_arquivo.split("-")
        print(self.diretorio_origem[2])
        carro = self.diretorio_origem_info[1]
    ...
    def cria_diretorio(self, carro, camera):

        data = self.diretorio_origem_info[2]
        path = join(self.destino, carro, camera, data)
    ...
    def run(self):
        ...
        diretorio_destino = self.cria_diretorio(carro, camera)
